...
{
    static NSString *CellIdentifier = @"PostsIndexCustom";
...
//    }
    ...
    PostsIndexCustom *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
